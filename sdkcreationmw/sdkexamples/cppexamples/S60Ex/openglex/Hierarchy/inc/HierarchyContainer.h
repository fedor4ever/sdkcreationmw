...
#ifndef HIERARCHYCONTAINER_H
#define HIERARCHYCONTAINER_H
 ...
 * Also uses the CHierarchy class to do the actual OpenGL ES rendering.
 */
class CHierarchyContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CHierarchy and uninitializes OpenGL ES.
         */
        virtual ~CHierarchyContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CHierarchy to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CHierarchyContainer.
         */
