...
#ifndef HIERARCHYAPPUI_H
#define HIERARCHYAPPUI_H
...
/**
 * Application UI class that contains the CHierarchyContainer
 * (as required by the Symbian UI application architecture).
 */
class CHierarchyAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor. Creates the CHierarchyContainer
         * and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CHierarchyContainer from the control
         * stack and destroys it.
         */
        virtual ~CHierarchyAppUi();
    ...
    private: //Data
        ...
        CHierarchyContainer* iAppContainer;
    };
