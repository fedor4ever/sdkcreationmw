...
#ifndef SIMPLECUBEPIXMAPCONTAINER_H
#define SIMPLECUBEPIXMAPCONTAINER_H
 ...
 * Also uses the CSimpleCubePixmap class to do the actual OpenGL ES rendering.
 */
class CSimpleCubePixmapContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CSimpleCubePixmap and uninitializes OpenGL ES.
         */
        virtual ~CSimpleCubePixmapContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CSimpleCubePixmap to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CSimpleCubePixmapContainer.
         */
    ...
    private: //data
        ...
        /** The bitmap where the framebuffer is drawn. */
        CWsBitmap*  iPixmap;
...
/** Application UI class for querying the client rectangle size. */ 
    ...
    public:  //data
        ...
        CSimpleCubePixmap* iSimpleCubePixmap;
    };
