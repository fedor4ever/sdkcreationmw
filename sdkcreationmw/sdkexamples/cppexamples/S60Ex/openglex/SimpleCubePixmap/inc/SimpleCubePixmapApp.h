...
#ifndef SIMPLECUBEPIXMAPAPP_H
#define SIMPLECUBEPIXMAPAPP_H
...
const TUid KUidSimpleCubePixmap = { 0xA000021C };
 ...
 */
class CSimpleCubePixmapApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CSimpleCubePixmapDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidSimpleCubePixmap).
         * @return Value of KUidSimpleCubePixmap.
         */
