...
#ifndef MIPMAPPINGAPPUI_H
#define MIPMAPPINGAPPUI_H
...
class CMipmappingContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CMipmappingContainer
 * (as required by the Symbian UI application architecture).
 */
class CMipmappingAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor that can call methods that may leave.
         * Creates the CMipmappingContainer and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CMipmappingContainer from the control
         * stack and destroys it.
         */
        virtual ~CMipmappingAppUi();
    ...
    private: //Data
        ...
        CMipmappingContainer* iAppContainer;
    };
