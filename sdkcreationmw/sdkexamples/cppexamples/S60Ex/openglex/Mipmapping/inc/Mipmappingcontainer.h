...
#ifndef MIPMAPPINGCONTAINER_H
#define MIPMAPPINGCONTAINER_H
 ...
 * Also uses the CMipmapping class to do the actual OpenGL ES rendering.
 */
class CMipmappingContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CMipmapping and uninitializes OpenGL ES.
         */
        virtual ~CMipmappingContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CMipmapping to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CMipmappingContainer.
         */
    ...
    private: //data
        ...
        TUint32 iStartTimeTicks;
        /** Time when the previous frame was rendered. */
        TUint32 iLastFrameTimeSecs;
        /** Current average seconds per frame. Used to interpolated during frames when the internal clock hasn't updated. */
        TReal iSecondsPerFrame;
