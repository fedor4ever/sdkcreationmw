...
#ifndef MIPMAPPINGDOCUMENT_H
#define MIPMAPPINGDOCUMENT_H
 ...
 */
class CMipmappingDocument : public CAknDocument
    {
    public: // Constructors and destructor

        /**
         * Factory method for creating a new CMipmappingDocument object.
		 * Calls the hidden constructors.
         */
        static CMipmappingDocument* NewL(CEikApplication& aApp);

        /**
         * Destructor. Does nothing.
         */
        virtual ~CMipmappingDocument();
    ...
    public: // Hidden constructors
         ...
         */
        CMipmappingDocument(CEikApplication& aApp);

    private: // Functions from base classes

        /**
         * From CEikDocument, creates and returns CMipmappingAppUi application UI object.
         */
