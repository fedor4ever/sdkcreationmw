...
#ifndef LENSFLAREAPP_H
#define LENSFLAREAPP_H
...
const TUid KUidLensFlare = { 0xA0000215 };
 ...
 */
class CLensFlareApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CLensFlareDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidLensFlare).
         * @return Value of KUidLensFlare.
         */
