...
#ifndef LENSFLARECONTAINER_H
#define LENSFLARECONTAINER_H
 ...
 * Also uses the CLensFlare class to do the actual OpenGL ES rendering.
 */
class CLensFlareContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CLensFlare and uninitializes OpenGL ES.
         */
        virtual ~CLensFlareContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CLensFlare to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CLensFlareContainer.
         */
