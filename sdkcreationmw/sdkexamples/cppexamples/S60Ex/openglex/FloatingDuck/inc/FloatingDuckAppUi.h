...
#ifndef FLOATINGDUCKAPPUI_H
#define FLOATINGDUCKAPPUI_H
...
class CFloatingDuckContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CFloatingDuckContainer
 * (as required by the Symbian UI application architecture).
 */
class CFloatingDuckAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor that can call methods that may leave.
         * Creates the CFloatingDuckContainer and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CFloatingDuckContainer from the control
         * stack and destroys it.
         */
        virtual ~CFloatingDuckAppUi();
    ...
    private: //Data
        ...
        CFloatingDuckContainer* iAppContainer;
    };
