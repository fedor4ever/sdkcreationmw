...
#ifndef FLOATINGDUCKCONTAINER_H
#define FLOATINGDUCKCONTAINER_H
 ...
 * Also uses the CFloatingDuck class to do the actual OpenGL ES rendering.
 */
class CFloatingDuckContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CFloatingDuck and uninitializes OpenGL ES.
         */
        virtual ~CFloatingDuckContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CFloatingDuck to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CFloatingDuckContainer.
         */
