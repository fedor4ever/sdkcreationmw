...
#ifndef MULTITEXAPP_H
#define MULTITEXAPP_H
...
const TUid KUidMultiTex = { 0xA0000216 };
 ...
 */
class CMultiTexApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CMultiTexDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidMultiTex).
         * @return Value of KUidMultiTex.
         */
