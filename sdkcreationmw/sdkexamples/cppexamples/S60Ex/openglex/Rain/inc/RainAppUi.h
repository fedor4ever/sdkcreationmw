...
class CRainContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CRainContainer
 * (as required by the Symbian UI application architecture).
 */
class CRainAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor that can call methods that may leave.
         * Creates the CRainContainer and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CRainContainer from the control
