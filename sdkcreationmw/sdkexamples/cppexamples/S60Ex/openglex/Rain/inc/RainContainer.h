...
#ifndef RAINCONTAINER_H
#define RAINCONTAINER_H
 ...
 * Also uses the CRain class to do the actual OpenGL ES rendering.
 */
class CRainContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CRain and uninitializes OpenGL ES.
         */
        virtual ~CRainContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CRain to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CRainContainer.
         */
