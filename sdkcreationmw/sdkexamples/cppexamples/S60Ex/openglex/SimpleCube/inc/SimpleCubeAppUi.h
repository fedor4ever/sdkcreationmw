...
class CSimpleCubeContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CSimpleCubeContainer
...
class CSimpleCubeAppUi : public CAknAppUi
    ...
    public: // Constructors and destructor
        ...
        /**
         * Second phase constructor. Creates the CSimpleCubeContainer
         * and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CSimpleCubeContainer from the control
