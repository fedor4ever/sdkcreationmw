...
#ifndef ENVMAPPINGCONTAINER_H
#define ENVMAPPINGCONTAINER_H

// INCLUDES
#include <coecntrl.h>
#include <GLES/egl.h>         // EGL header file
#include "EnvMappingAppUi.h"
#include "EnvMapping.h"       // Main OpenGL ES class
#include <akndef.h>
#include <aknappui.h> 
 ...
 * Also uses the CEnvMapping class to do the actual OpenGL ES rendering.
 */
class CEnvMappingContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor

        /**
         * EPOC default constructor. Initializes the OpenGL ES for rendering.
         * @param aRect Screen rectangle for container.
         */
         void ConstructL(const TRect& aRect, CAknAppUi* aAppUi);

        /**
         * Destructor. Destroys the CPeriodic, CEnvMapping and uninitializes OpenGL ES.
         */
        virtual ~CEnvMappingContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CEnvMapping to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CEnvMappingContainer.
         */
