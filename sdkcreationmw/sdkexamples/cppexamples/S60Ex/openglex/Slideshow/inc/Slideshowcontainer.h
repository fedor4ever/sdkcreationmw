 ...
 * Also uses the CSlideshow class to do the actual OpenGL ES rendering.
 */
class CSlideshowContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CSlideshow and uninitializes OpenGL ES.
         */
        virtual ~CSlideshowContainer();
