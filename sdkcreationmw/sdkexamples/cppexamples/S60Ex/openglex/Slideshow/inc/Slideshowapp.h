...
const TUid KUidSlideshow = { 0xA0000224 };
 ...
 */
class CSlideshowApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CSlideshowDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidSlideshow).
         * @return Value of KUidSlideshow.
         */
