...
#ifndef BILLBOARDAPP_H
#define BILLBOARDAPP_H
...
const TUid KUidBillboard = { 0xA0000212 };
 ...
 */
class CBillboardApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CBillboardDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidBillboard).
         * @return Value of KUidBillboard.
         */
