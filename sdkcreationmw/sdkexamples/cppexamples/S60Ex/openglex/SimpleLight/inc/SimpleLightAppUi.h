...
#ifndef SIMPLELIGHTAPPUI_H
#define SIMPLELIGHTAPPUI_H
...
class CSimpleLightContainer;


// CLASS DECLARATION

/**
 * Application UI class that is contains the CSimpleLightContainer
 * (as required by the Symbian UI application architecture).
 */
class CSimpleLightAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor. Creates the CSimpleLightContainer
         * and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CSimpleLightContainer from the control
         * stack and destroys it.
         */
        virtual ~CSimpleLightAppUi();
    ...
    private: //Data
        ...
        CSimpleLightContainer* iAppContainer;
    };
