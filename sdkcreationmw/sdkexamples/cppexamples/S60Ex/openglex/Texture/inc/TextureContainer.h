...
#include "Texture.h"       // Main OpenGL ES class
#include <akndef.h>
#include <aknappui.h> 
 ...
 * Also uses the CTexture class to do the actual OpenGL ES rendering.
 */
class CTextureContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CTexture and uninitializes OpenGL ES.
         */
    ...
    public: // New functions
         ...
         * light from turning off and orders the CTexture to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CTextureContainer.
         */
