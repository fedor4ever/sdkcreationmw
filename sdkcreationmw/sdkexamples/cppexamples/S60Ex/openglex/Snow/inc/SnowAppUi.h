...
class CSnowContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CSnowContainer
 * (as required by the Symbian UI application architecture).
 */
class CSnowAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor that can call methods that may leave.
         * Creates the CSnowContainer and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CSnowContainer from the control
