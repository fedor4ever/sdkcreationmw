...
class CSnow
	...
	public: // New functions.
		 ...
		 */
		void DrawCloud( GLfloat aDeltaTimeSecs);
...
/**
 * Snowfall particle effect class. Snowflakes are released from within the rectangle
...
class CSnowfall: public CParticleEngine
{
	public: // Constructors and destructor
        ...
        /**
         * Factory method for creating a new CSnowfall object.
         * @param aParticlesCount Number of particles used to create the snow effect.
         * @param aPosition Position of the snow particle generator.
         * @param aWidth Width of the snow area.
         * @param aDepth Height of the snow area.
         * @param aGroundLevel Ground level after which particle is reset back to beginning.
		 * @param aTextureManager Texture manager that is used to load the snow texture.
         */
	...
	protected:
        ...
        /**
         * Second phase contructor. Constructs the snow effect using the given parameters.
         * @param aParticlesCount Number of particles used to create the snow effect.
         * @param aPosition Position of the snow particle generator.
         * @param aWidth Width of the snow area.
         * @param aDepth Height of the snow area.
	...
	public: // Functions from base classes
		 ...
		 * Renders each particle to the screen as texture mapped polygon that uses the iTexture as texture.
		 */
		void RenderEngine(TCamera& aCamera);

	public: // Data

		/** Width of the particle source area. This defines the width of the area where the snow falls. */
		GLfloat iWidth;
		/** Depth of the particle source area. This defines the depth of the area where the snow falls. */
		GLfloat iDepth;
