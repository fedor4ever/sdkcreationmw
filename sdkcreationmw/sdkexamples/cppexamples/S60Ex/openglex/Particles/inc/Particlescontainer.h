 ...
 * Also uses the CParticles class to do the actual OpenGL ES rendering.
 */
class CParticlesContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CParticles and uninitializes OpenGL ES.
         */
        virtual ~CParticlesContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CParticles to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CParticlesContainer.
         */
