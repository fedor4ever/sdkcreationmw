...
#ifndef PARTICLESAPP_H
#define PARTICLESAPP_H
...
const TUid KUidParticles = { 0xA0000221 };
 ...
 */
class CParticlesApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CParticlesDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidParticles).
         * @return Value of KUidParticles.
         */
