...
#ifndef SHADOWSAPPUI_H
#define SHADOWSAPPUI_H
...
class CShadowsContainer;


// CLASS DECLARATION

/**
 * Application UI class that contains the CShadowsAppUi
 * (as required by the Symbian UI application architecture).
 */
class CShadowsAppUi : public CAknAppUi
    {
    public: // // Constructors and destructor

        /**
         * Second phase constructor. Creates the CShadowsContainer
         * and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CShadowsContainer from the control
         * stack and destroys it.
         */
        virtual ~CShadowsAppUi();
    ...
    private: //Data
        ...
        CShadowsContainer* iAppContainer;
    };
