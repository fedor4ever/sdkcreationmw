...
#ifndef SHADOWSCONTAINER_H
#define SHADOWSCONTAINER_H
 ...
 * Also uses the CShadow class to do the actual OpenGL ES rendering.
 */
class CShadowsContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CShadow and uninitializes OpenGL ES.
         */
        virtual ~CShadowsContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CShadow to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CShadowsContainer.
         */
