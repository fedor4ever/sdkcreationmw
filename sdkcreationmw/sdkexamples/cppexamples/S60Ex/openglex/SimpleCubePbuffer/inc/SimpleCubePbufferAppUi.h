...
#ifndef SIMPLECUBEPBUFFERAPPUI_H
#define SIMPLECUBEPBUFFERAPPUI_H
...
class CSimpleCubePbufferContainer;


// CLASS DECLARATION

/**
 * Application UI class that is contains the CSimpleCubePbufferContainer
 * (as required by the Symbian UI application architecture).
 */
class CSimpleCubePbufferAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor. Creates the CSimpleCubePbufferContainer
         * and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CSimpleCubePbufferContainer from the control
         * stack and destroys it.
         */
        virtual ~CSimpleCubePbufferAppUi();
    ...
    private: //Data
        ...
        CSimpleCubePbufferContainer* iAppContainer;
    };
