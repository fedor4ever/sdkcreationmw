...
#ifndef BUMPMAPCONTAINER_H
#define BUMPMAPCONTAINER_H
 ...
 * Also uses the CBumpMap class to do the actual OpenGL ES rendering.
 */
class CBumpMapContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CBumpMap and uninitializes OpenGL ES.
         */
        virtual ~CBumpMapContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CBumpMap to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CBumpMapContainer.
         */
