...
#ifndef BUMPMAPAPPUI_H
#define BUMPMAPAPPUI_H
...
class CBumpMapContainer;

// CLASS DECLARATION

/**
 * Application UI class that contains the CBumpMapContainer
 * (as required by the Symbian UI application architecture).
 */
class CBumpMapAppUi : public CAknAppUi
    {
    public: // Constructors and destructor

        /**
         * Second phase constructor that can call methods that may leave.
         * Creates the CBumpMapContainer and adds it to the control stack.
         */
        void ConstructL();

        /**
         * Destructor. Removes CBumpMapContainer from the control
         * stack and destroys it.
         */
        virtual ~CBumpMapAppUi();
    ...
    private: //Data
        ...
        CBumpMapContainer* iAppContainer;
    };
