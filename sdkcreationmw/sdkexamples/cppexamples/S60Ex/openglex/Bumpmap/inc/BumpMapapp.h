...
const TUid KUidBumpMap = { 0xA0000220 };
 ...
 */
class CBumpMapApp : public CAknApplication
    {
    private: // Functions from base classes

        /**
         * From CApaApplication, creates and returns CBumpmapDocument document object.
         * @return Pointer to the created document object.
         */
        CApaDocument* CreateDocumentL();

        /**
         * From CApaApplication, returns application's UID (KUidBumpmap).
         * @return Value of KUidBumpmap.
         */
