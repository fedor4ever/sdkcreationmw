...
#ifndef PICKSELECTCONTAINER_H
#define PICKSELECTCONTAINER_H
 ...
 * Also uses the CPickSelect class to do the actual OpenGL ES rendering.
 */
class CPickSelectContainer : public CCoeControl, MCoeControlObserver
    {
    public: // Constructors and destructor
        ...
        /**
         * Destructor. Destroys the CPeriodic, CPickSelect and uninitializes OpenGL ES.
         */
        virtual ~CPickSelectContainer();

    public: // New functions

        /**
         * Callback function for the CPeriodic. Calculates the current frame, keeps the background
         * light from turning off and orders the CPickSelect to do the rendering for each frame.
         *@param aInstance Pointer to this instance of CPickSelectContainer.
         */
