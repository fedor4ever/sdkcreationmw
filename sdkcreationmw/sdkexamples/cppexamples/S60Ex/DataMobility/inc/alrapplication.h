...
#ifndef ALRAPPLICATION_H
#define ALRAPPLICATION_H
...
/**
*  CALRApplication  example of class using connection
*                   and Mobility extension API.
*
*/
class CALRApplication : public CActive, public MMobilityProtocolResp
    ...
    public:  // Constructors and destructor
        ...
        */
        static CALRApplication* NewL( MDataMobilityPrinter& aObserver );
    ...
    private:
        ...
        */
        CALRApplication( MDataMobilityPrinter& aObserver );
