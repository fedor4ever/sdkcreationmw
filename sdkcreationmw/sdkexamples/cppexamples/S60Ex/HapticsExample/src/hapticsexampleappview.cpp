...
void CHapticsExampleAppView::PlayBounceEffect( TInt aBounceVelocity )
    ...
    if ( 0 != aBounceVelocity )
        ...
        if ( iEffectFileHandle )
            {
            HBufC8* ptr = 
                ( aBounceVelocity < KBounceLevel6Percent ? 
                    KEffectBounce6Name().Alloc() :
                  aBounceVelocity < KBounceLevel5Percent ? 
                    KEffectBounce5Name().Alloc() :
                  aBounceVelocity < KBounceLevel4Percent ? 
                    KEffectBounce4Name().Alloc() :
                  aBounceVelocity < KBounceLevel3Percent ? 
                    KEffectBounce3Name().Alloc() :
                  aBounceVelocity < KBounceLevel2Percent ? 
                    KEffectBounce2Name().Alloc() : 
                  KEffectBounce1Name().Alloc() );
            ...
            magnitude /= 
                aBounceVelocity < KBounceLevel6Percent ? 
                    KBounceLevel6Magnitude :
                aBounceVelocity < KBounceLevel5Percent ? 
                    KBounceLevel5Magnitude :
                aBounceVelocity < KBounceLevel4Percent ? 
                    KBounceLevel4Magnitude :
                aBounceVelocity < KBounceLevel3Percent ? 
                    KBounceLevel3Magnitude :
                aBounceVelocity < KBounceLevel2Percent ? 
                    KBounceLevel2Magnitude : 1;
            TInt tmpHandle( 0 );
            CHWRMHaptics::THWRMHapticsMagSweepEffect effect;
