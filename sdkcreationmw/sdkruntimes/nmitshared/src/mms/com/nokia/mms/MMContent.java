...
public class MMContent implements Serializable {
  ...
  private String m_sHeaders = null;
 ...
 /**
  ...
  /**
   * Set the header string for this content.
   *
   * @param headers the unparsed HTTP headers.
   */
  ...
  /**
   * Retrieves the header string for this content.
   *
   * @return the array of byte
   */
  ...
  /**
   * Creates an empty object representing the content.
   */
  public MMContent() {
  }
