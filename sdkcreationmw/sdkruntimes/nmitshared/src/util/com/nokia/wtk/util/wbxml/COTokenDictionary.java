...
*/
/**
 * COTokenDictionary.java                   2000/09/13
 */

// ========================================================================
//  Name        : COTokenDictionary.java
//  Part of     : 
//  Description : 
//  Version     : 
//
...
/**
 * A WBXML TokenDictionary for Binary Cache Operations messages.
 *
 */
class COTokenDictionary implements WBXMLParser.TokenDictionary {
    /**
     * Creates a new COTokenDictionary.
     *
     * @param version the CO version (Currently, only "1.0")
     */
    public COTokenDictionary(String version) {
    ...
    public String getContentType() {
        return MimeType.CACHE_OP_BINARY;
    }
    ...
    /**
     * Gets the string representation of a string extension.  CO doesn't support these.
     *
    ...
    public String filterOpaqueData(String tag, String target, byte[] bytes, CharacterEncoding enc) {
        ...
        // System.out.println("COTokDict: Unknown Opaque data for attr " + target);
        return outStr;
    }
    ...
    /**
     * The set of available tag token definitions for CO 1.0
     */
    private static final TagToken[] tagSet_1_0 = {
        new TagToken(0x05,  "co"),
        new TagToken(0x06,  "invalidate-object"),
        new TagToken(0x07,  "invalidate-service")
    };


    /**
     * The set of available attribute start definitions for CO 1.0
     */
    private static final AttrStart[] startSet_1_0 = {
        new AttrStart(0x05, "uri",   null),
        new AttrStart(0x06, "uri",   "http://"),
        new AttrStart(0x07, "uri",   "http://www."),
        new AttrStart(0x08, "uri",   "https://"),
        new AttrStart(0x09, "uri",   "https://www.")
    };


    /**
     * The set of available attribute value definitions for CO 1.0
     */
