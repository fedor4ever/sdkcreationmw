...
/**
 * ContentViewer for WML source.
 */
public class WMLSourceViewer implements ContentViewer {

  /**
   * Constructor.
   * @param content the content this WMLSourceViewer represents.
   */
  public WMLSourceViewer( DeviceContentReceived content ) {
