 ...
 *  just extends the DeviceSocketListener interface with no additions.
 *  However, this doesn't have to be the case: DeviceSocketListener is
 *  the interface to the Diagnostics component itself, while SocketAdapter
 *  is the interface between the SDK and the diagnostics adapter. The two interfaces
 *  may be different. </p>
 * <p>Company: Nokia</p>
 * @version 1.0
 */
public interface SocketAdapter extends DeviceSocketListener {
}
