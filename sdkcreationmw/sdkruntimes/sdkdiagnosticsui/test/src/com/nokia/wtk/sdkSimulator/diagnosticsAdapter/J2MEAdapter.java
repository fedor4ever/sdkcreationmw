 ...
 *  just extends the DeviceJ2MEListener interface with no additions.
 *  However, this doesn't have to be the case: DeviceJ2MEListener is
 *  the interface to the Diagnostics component itself, while J2MEAdapter
 *  is the interface between the SDK and the diagnostics adapter. The two interfaces
 *  may be different. </p>
 * <p>Company: Nokia</p>
 * @version 1.0
 */
public interface J2MEAdapter extends DeviceJ2MEListener {
}
