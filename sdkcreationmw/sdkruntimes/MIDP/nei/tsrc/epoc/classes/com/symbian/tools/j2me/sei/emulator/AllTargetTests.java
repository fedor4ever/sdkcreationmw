...
public class AllTargetTests extends TestSuite {
  ...
  public AllTargetTests() {
    this("all Target tests");
  }

  public AllTargetTests(String s) {
    super(s);
    addTestSuite(com.symbian.tools.j2me.sei.emulator.TestLauncher_TARGET_INTERACTIVE.class);
    //addTestSuite(com.symbian.tools.j2me.sei.emulator.TestLauncher_NAIVE_NONINTERACTIVE.class);
  }

  public static Test suite() {
    return new AllTargetTests();
  }
}
