...
public class AllWin32Tests extends TestSuite {
  ...
  public AllWin32Tests() {
    this("all Win32 tests");
  }

  public AllWin32Tests(String s) {
    super(s);
    addTestSuite(com.symbian.tools.j2me.sei.emulator.TestLauncher_WIN32_INTERACTIVE.class);
    //addTestSuite(com.symbian.tools.j2me.sei.emulator.TestLauncher_NAIVE_NONINTERACTIVE.class);
  }

  public static Test suite() {
    return new AllWin32Tests();
  }
}
