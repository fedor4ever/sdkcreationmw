...
public class AllNaiveNonInteractiveTests extends TestSuite {
  ...
  public AllNaiveNonInteractiveTests() {
    this("all naive NON INTERACTIVE tests");
  }

  public AllNaiveNonInteractiveTests(String s) {
    super(s);
    addTestSuite(com.symbian.tools.j2me.sei.emulator.TestLauncher_NAIVE_NONINTERACTIVE.class);
  }

  public static Test suite() {
    return new AllNaiveNonInteractiveTests();
  }
}
